...
import org.seasar.jsf.validator.S2MultiFieldValidator;

public class CalendarValidator extends S2MultiFieldValidator {
    ...
    protected void doValidate(FacesContext context, UIComponent component,
        ...
        if (targetValues.length < 2 || targetValues[0] == null
                || targetValues[1] == null) {
        ...
        try {
            ...
            date = Integer.parseInt(value.toString());
        ...
        try {
            ...
            Object[] args = { UIComponentUtil.getLabel(component),
                    targetValues[0], targetValues[1], value };
            throw new ValidatorException(MessageUtil.getErrorMessage(
