...
public class PageContextWriterTest extends TestCase {
    ...
    public void testWrite() throws Exception {
        ...
        // ## Assert ##
        assertEquals("write��PageContextImpl#getOut()�ֈϏ�Ă��邱��", "7650", sb
            .toString());
    }
    ...
    public void testFlush() throws Exception {
        ...
        // ## Assert ##
        assertEquals("flush��PageContextImpl#getOut()�ֈϏ�Ă��邱��", true, called[0]);
    }
    ...
    public void testClose() throws Exception {
        ...
        // ## Assert ##
        assertEquals("close��PageContextImpl#getOut()�ֈϏ�Ă��邱��", true, called[0]);
    }
