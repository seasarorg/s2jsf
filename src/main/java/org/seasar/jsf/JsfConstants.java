...
public interface JsfConstants {
    ...
    public String[] COMMON_PASSTROUGH_ATTRIBUTES_WITHOUT_STYLE_AND_ONCLICK = (String[]) ArrayUtil
            .add(EVENT_HANDLER_ATTRIBUTES_WITHOUT_ONCLICK,
    ...
    public String[] ANCHOR_PASSTHROUGH_ATTRIBUTES_WITHOUT_STYLE_AND_ONCLICK = (String[]) ArrayUtil
            .add(ANCHOR_ATTRIBUTES,
                    COMMON_PASSTROUGH_ATTRIBUTES_WITHOUT_STYLE_AND_ONCLICK);
