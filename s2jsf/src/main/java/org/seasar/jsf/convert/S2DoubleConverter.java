 ...
 * @author manhole
 */
public class S2DoubleConverter extends DoubleConverter {

    protected static final String CONVERSION_MESSAGE_ID = "javax.faces.convert.DoubleConverter.CONVERSION";
