 ...
 * @author manhole
 */
public class S2BigIntegerConverter extends BigIntegerConverter {

    protected static final String CONVERSION_MESSAGE_ID = "javax.faces.convert.BigIntegerConverter.CONVERSION";
