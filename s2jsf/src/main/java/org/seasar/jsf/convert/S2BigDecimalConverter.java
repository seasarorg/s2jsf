 ...
 * @author manhole
 */
public class S2BigDecimalConverter extends BigDecimalConverter {

    protected static final String CONVERSION_MESSAGE_ID = "javax.faces.convert.BigDecimalConverter.CONVERSION";
